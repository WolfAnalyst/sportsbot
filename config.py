...
# How far back to look. 24h covers a re-post the next morning for the same race day
# while staying well short of the same horse's next start a week later. The measured
# re-deliveries were 142, 154 and 219 minutes.
RACING_DUP_RUNNER_LOOKBACK_HOURS = float(
    os.getenv("RACING_DUP_RUNNER_LOOKBACK_HOURS", "24"))
