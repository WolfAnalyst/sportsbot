...
# reject) — ONE reroute round, then it's manual. ALL AFL disposals fan-out (Saiyan
# + Eddie, over + under; SGMs are a different path). v5.77 was Eddie-overs-only;
# widened 06-20 ("whatever's not filled gets rerouted, overs/unders"). Kill-switch.
